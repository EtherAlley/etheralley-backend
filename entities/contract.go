...
type Contract struct {
	...
	Interface  common.Interface  `bson:"interface" json:"interface" validate:"required,oneof=ERC721 ERC1155 ERC20 ENS_REGISTRAR SUSHISWAP_EXCHANGE UNISWAP_V2_EXCHANGE  UNISWAP_V3_EXCHANGE"`
}
